...
description: A menu action to execute a command.
...
![banner](../../../assets/img/actions/execute-command.png)
...
Kando comes with an **app picker** which allows you to select one of your installed applications.
...
![app-picker](../../../assets/img/app-picker.png)
