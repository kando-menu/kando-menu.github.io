...
:-- | :---: | :---: | :---: 
AutoHotkey **([→ Tutorial](/ahk-tutorial))** | <Icon name="seti:windows" class="inline-icon" />         | ✅ | 🖱️ + ✍️ + 🎮 
Input Remapper **([→ Tutorial](/input-remapper-tutorial))** | <Icon name="linux" class="inline-icon" />            | ✅ | 🖱️ + ✍️ + 🎮 
