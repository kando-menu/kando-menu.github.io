...
If you want to contribute by fixing a bug or implementing a feature yourself, you are very welcome to do so!
...
<Aside type="note" title="Keep a Changelog!">
...
If you encounter any issues while working on Kando, feel free to ask for help in the comments of the corresponding issue or join the development chat on [Discord](https://discord.gg/hZwbVSDkhy)!
</Aside>
