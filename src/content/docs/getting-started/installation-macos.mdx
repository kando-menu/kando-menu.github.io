...
3. Press <kbd>Ctrl</kbd> + <kbd>Space</kbd> to open the example menu! The only thing left to do is to grant the required permissions. See the [Grant Required Permissions](#grant-required-permissions) section below for more information.
...
4. Press <kbd>Ctrl</kbd> + <kbd>Space</kbd> to open the example menu! The only thing left to do is to grant the required permissions. See the [Grant Required Permissions](#grant-required-permissions) section below for more information.
