...
<Intro>
  With Kando, you can bind a menu to a keyboard shortcut and use menu items to simulate
  keyboard hotkeys or macros. This is a bit confusing as all are configured similarly, but
...
| ---------------------------------------------------- | ------------------------------------------------ |
| ![shortcut](../../assets/img/key-names-shortcut.png) | ![hotkey](../../assets/img/key-names-hotkey.png) |
...
On most platforms, Kando uses the [Electron Accelerator](https://www.electronjs.org/docs/latest/tutorial/keyboard-shortcuts) format to bind shortcuts.
