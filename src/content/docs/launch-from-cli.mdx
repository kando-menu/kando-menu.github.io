...
When you run Kando from the command line, you can use the [command line interface](/cli-interface) to interact with Kando.
This allows you to open menus, trigger shortcuts, and more.

<LinkCard title="Command Line Interface" description="Click here to learn more about Kando's command line interface." href="/cli-interface"/>