...
You can add any number of actions to these workflows, and compose complex sequences of actions which are executed when you select or hover over the item.
