...
<Steps>
1. Download the new AppImage and get its sha256:
   ```bash
    ...
    ```
2. Edit [`menu.kando.Kando.yml`](https://github.com/flathub/menu.kando.Kando/blob/master/menu.kando.Kando.yml) to include the new link to the AppImage and the new sha256.
