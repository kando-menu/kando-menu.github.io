...
For now, Kando comes with just one sound theme pre-installed.
However, you can find more sound themes in the [Kando Sound Themes Repository](https://github.com/kando-menu/sound-themes)!
</Aside>
