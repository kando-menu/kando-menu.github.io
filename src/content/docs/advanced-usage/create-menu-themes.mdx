...
A menu theme is a directory containing at least three files: `theme.json5`, `theme.css`, and `preview.jpg`.
...
## <Icon name="solar:file-smile-bold-duotone" class="inline-icon" /> A Preview for your Theme
