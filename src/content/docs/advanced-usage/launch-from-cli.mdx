...
<Tabs>
  ...
  <TabItem label="macOS" icon="apple">
    ...
    If you run Kando from the command line, you need to grant the required permissions _to the terminal_. See [Installing on macOS](/getting-started/installation-macos#required-permissions) to learn which permissions are required.
    </Aside>
